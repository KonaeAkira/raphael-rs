...
fn rarefied_tacos_de_carne_asada_4785_4758() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 1900748,
                pareto_values: 48772663,
            },
            step_lb_stats: StepLbSolverStats {
                states: 1627601,
                pareto_values: 35914698,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn rakaznar_lapidary_hammer_4462_4391() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 1431618,
                pareto_values: 26330670,
            },
            step_lb_stats: StepLbSolverStats {
                states: 755810,
                pareto_values: 13913641,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn claro_walnut_lumber_4900_4800() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 1302478,
                pareto_values: 11857945,
            },
            step_lb_stats: StepLbSolverStats {
                states: 222828,
                pareto_values: 2206962,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn rarefied_tacos_de_carne_asada_4966_4817() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 1357929,
                pareto_values: 17030035,
            },
            step_lb_stats: StepLbSolverStats {
                states: 435523,
                pareto_values: 6644352,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn archeo_kingdom_broadsword_4966_4914() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 1781267,
                pareto_values: 37282570,
            },
            step_lb_stats: StepLbSolverStats {
                states: 801669,
                pareto_values: 16087443,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn hardened_survey_plank_5558_5216() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 2040882,
                pareto_values: 34756087,
            },
            step_lb_stats: StepLbSolverStats {
                states: 342379,
                pareto_values: 5323872,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
