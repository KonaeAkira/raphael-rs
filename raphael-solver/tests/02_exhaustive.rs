...
fn rarefied_tacos_de_carne_asada_4785_4758() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 943006,
                states_on_shards: 10514,
                values: 22077132,
            },
            step_lb_stats: StepLbSolverStats {
...
fn rakaznar_lapidary_hammer_4462_4391() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 808300,
                states_on_shards: 404,
                values: 11447001,
            },
            step_lb_stats: StepLbSolverStats {
...
fn black_star_4048_3997() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 676932,
                states_on_shards: 924,
                values: 3040229,
            },
            step_lb_stats: StepLbSolverStats {
...
fn claro_walnut_lumber_4900_4800() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 841227,
                states_on_shards: 1317,
                values: 5365016,
            },
            step_lb_stats: StepLbSolverStats {
...
fn rarefied_tacos_de_carne_asada_4966_4817() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 908466,
                states_on_shards: 886,
                values: 7194891,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 266926,
...
fn archeo_kingdom_broadsword_4966_4914() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 1108202,
                states_on_shards: 1063,
                values: 15903907,
            },
            step_lb_stats: StepLbSolverStats {
...
fn hardened_survey_plank_5558_5216() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 989749,
                states_on_shards: 10009,
                values: 16066513,
            },
            step_lb_stats: StepLbSolverStats {
...
fn ce_stellar_steady_hand() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 2408496,
                states_on_shards: 84387,
                values: 50006082,
            },
            step_lb_stats: StepLbSolverStats {
...
fn ce_stellar_steady_hand_2() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 4327021,
                states_on_shards: 44075,
                values: 74599128,
            },
            step_lb_stats: StepLbSolverStats {
