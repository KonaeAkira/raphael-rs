...
fn pactmaker_3240_3130() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 259220,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 3280,
                dropped_nodes: 0,
...
fn rarefied_tacos_de_carne_asada_4785_4758() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 1079192,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 48136,
                dropped_nodes: 181517,
            ...
            step_lb_stats: StepLbSolverStats {
                precomputed_states: 1425760,
                states: 1886955,
                pareto_values: 18900914,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn stuffed_peppers_2() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 523107,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 12078,
                dropped_nodes: 0,
...
fn stuffed_peppers_2_quick_innovation() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 542035,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 24390,
                dropped_nodes: 13,
...
fn rakaznar_lapidary_hammer_4462_4391() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            step_lb_stats: StepLbSolverStats {
                precomputed_states: 1011808,
                states: 1051633,
                pareto_values: 8029730,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn black_star_4048_3997() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            step_lb_stats: StepLbSolverStats {
                precomputed_states: 283678,
                states: 283678,
                pareto_values: 1021436,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn claro_walnut_lumber_4900_4800() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            step_lb_stats: StepLbSolverStats {
                precomputed_states: 366375,
                states: 436151,
                pareto_values: 2105444,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn rakaznar_lapidary_hammer_4900_4800() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            step_lb_stats: StepLbSolverStats {
                precomputed_states: 893254,
                states: 918145,
                pareto_values: 5807683,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn rarefied_tacos_de_carne_asada_4966_4817() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            step_lb_stats: StepLbSolverStats {
                precomputed_states: 751808,
                states: 786712,
                pareto_values: 4776003,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn archeo_kingdom_broadsword_4966_4914() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 1156938,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 16180,
                dropped_nodes: 237115,
            ...
            step_lb_stats: StepLbSolverStats {
                precomputed_states: 996402,
                states: 1208027,
                pareto_values: 10176050,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn hardened_survey_plank_5558_5216() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            step_lb_stats: StepLbSolverStats {
                precomputed_states: 337929,
                states: 453110,
                pareto_values: 2875233,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
