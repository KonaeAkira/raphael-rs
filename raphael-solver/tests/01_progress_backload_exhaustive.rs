...
fn pactmaker_3240_3130() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 259187,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 3322,
                dropped_nodes: 0,
            },
            quality_ub_stats: QualityUbSolverStats {
                states: 1705998,
...
fn indagator_3858_4057() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 339029,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 2419,
                dropped_nodes: 0,
            },
            quality_ub_stats: QualityUbSolverStats {
                states: 2008164,
...
fn rarefied_tacos_de_carne_asada_4785_4758() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 1086214,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 49872,
                dropped_nodes: 188890,
            },
            quality_ub_stats: QualityUbSolverStats {
                states: 1888798,
                pareto_values: 36430178,
            },
            step_lb_stats: StepLbSolverStats {
                states: 1328324,
                pareto_values: 16693800,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn stuffed_peppers_2() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 523847,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 12149,
                dropped_nodes: 0,
            },
            quality_ub_stats: QualityUbSolverStats {
                states: 1885008,
...
fn stuffed_peppers_2_heart_and_soul() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 540399,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 7293,
                dropped_nodes: 0,
            },
            quality_ub_stats: QualityUbSolverStats {
                states: 3823877,
...
fn stuffed_peppers_2_quick_innovation() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 542251,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 24269,
                dropped_nodes: 13,
            },
            quality_ub_stats: QualityUbSolverStats {
                states: 3857035,
...
fn rakaznar_lapidary_hammer_4462_4391() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 1526999,
                pareto_values: 22675673,
            },
            step_lb_stats: StepLbSolverStats {
                states: 541468,
                pareto_values: 6181610,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn black_star_4048_3997() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 155322,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 11367,
                dropped_nodes: 129648,
            },
            quality_ub_stats: QualityUbSolverStats {
                states: 1362482,
                pareto_values: 7046249,
            },
            step_lb_stats: StepLbSolverStats {
                states: 108349,
                pareto_values: 718821,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn claro_walnut_lumber_4900_4800() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 345035,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 33716,
                dropped_nodes: 502870,
            },
            quality_ub_stats: QualityUbSolverStats {
                states: 1567156,
                pareto_values: 10548613,
            },
            step_lb_stats: StepLbSolverStats {
                states: 255748,
                pareto_values: 1756191,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn rakaznar_lapidary_hammer_4900_4800() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 1699791,
                pareto_values: 17982167,
            },
            step_lb_stats: StepLbSolverStats {
                states: 421913,
                pareto_values: 4169370,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn rarefied_tacos_de_carne_asada_4966_4817() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 1721663,
                pareto_values: 15645565,
            },
            step_lb_stats: StepLbSolverStats {
                states: 352820,
                pareto_values: 3320304,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn archeo_kingdom_broadsword_4966_4914() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 1240919,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 20583,
                dropped_nodes: 296931,
            },
            quality_ub_stats: QualityUbSolverStats {
                states: 2130360,
                pareto_values: 31410213,
            },
            step_lb_stats: StepLbSolverStats {
                states: 836731,
                pareto_values: 9274909,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn hardened_survey_plank_5558_5216() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            finish_states: 601175,
            search_queue_stats: SearchQueueStats {
                processed_nodes: 176138,
                dropped_nodes: 438878,
            },
            quality_ub_stats: QualityUbSolverStats {
                states: 2280136,
                pareto_values: 23970644,
            },
            step_lb_stats: StepLbSolverStats {
                states: 294372,
                pareto_values: 2736371,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
