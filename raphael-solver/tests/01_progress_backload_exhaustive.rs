    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 981434,
                states_on_shards: 4446,
                values: 16415362,
            },
...
fn pactmaker_3240_3130() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 841634,
                states_on_shards: 6692,
                values: 12778618,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 0,
...
fn pactmaker_3240_3130_heart_and_soul() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 1737798,
                states_on_shards: 9019,
                values: 26950388,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 0,
...
fn diadochos_4021_3660() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 911534,
                states_on_shards: 6031,
                values: 16870093,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 0,
...
fn indagator_3858_4057() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 995414,
                states_on_shards: 9005,
                values: 15979353,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 0,
...
fn rarefied_tacos_de_carne_asada_4785_4758() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 949319,
                states_on_shards: 10674,
                values: 16455703,
            },
            step_lb_stats: StepLbSolverStats {
...
fn stuffed_peppers_2_heart_and_soul() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 1947191,
                states_on_shards: 570,
                values: 21076334,
            },
            step_lb_stats: StepLbSolverStats {
...
fn stuffed_peppers_2_quick_innovation() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 1964793,
                states_on_shards: 377,
                values: 18315257,
            },
            step_lb_stats: StepLbSolverStats {
...
fn rakaznar_lapidary_hammer_4462_4391() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 813014,
                states_on_shards: 136,
                values: 9680699,
            },
            step_lb_stats: StepLbSolverStats {
                states_on_main: 429544,
...
fn black_star_4048_3997() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 708824,
                states_on_shards: 1960,
                values: 2793285,
            },
            step_lb_stats: StepLbSolverStats {
...
fn claro_walnut_lumber_4900_4800() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 852808,
                states_on_shards: 3866,
                values: 4645316,
            },
            step_lb_stats: StepLbSolverStats {
...
fn rakaznar_lapidary_hammer_4900_4800() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 903884,
                states_on_shards: 261,
                values: 7338659,
            },
            step_lb_stats: StepLbSolverStats {
...
fn rarefied_tacos_de_carne_asada_4966_4817() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 914369,
                states_on_shards: 305,
                values: 6447404,
            },
            step_lb_stats: StepLbSolverStats {
...
fn archeo_kingdom_broadsword_4966_4914() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 1125471,
                states_on_shards: 1109,
                values: 12916988,
            },
            step_lb_stats: StepLbSolverStats {
...
fn hardened_survey_plank_5558_5216() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states_on_main: 1003093,
                states_on_shards: 13953,
                values: 11587144,
            },
            step_lb_stats: StepLbSolverStats {
