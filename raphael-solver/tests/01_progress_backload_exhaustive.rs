...
fn rarefied_tacos_de_carne_asada_4785_4758() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 429233,
                processed_nodes: 69926,
            },
            finish_solver_stats: FinishSolverStats {
                states: 15891,
                values: 308710,
...
fn stuffed_peppers_2() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 44935,
                processed_nodes: 2686,
            },
            finish_solver_stats: FinishSolverStats {
                states: 15891,
                values: 210965,
...
fn stuffed_peppers_2_heart_and_soul() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 57348,
                processed_nodes: 3066,
            },
            finish_solver_stats: FinishSolverStats {
                states: 31096,
                values: 392377,
...
fn black_star_4048_3997() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 135525,
                processed_nodes: 9378,
            },
            finish_solver_stats: FinishSolverStats {
                states: 3248,
                values: 18046,
...
fn claro_walnut_lumber_4900_4800() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 488035,
                processed_nodes: 27738,
            },
            finish_solver_stats: FinishSolverStats {
                states: 8079,
                values: 25429,
...
fn archeo_kingdom_broadsword_4966_4914() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 257041,
                processed_nodes: 14898,
            },
            finish_solver_stats: FinishSolverStats {
                states: 13977,
                values: 379883,
...
fn hardened_survey_plank_5558_5216() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            search_queue_stats: SearchQueueStats {
                inserted_nodes: 1227685,
                processed_nodes: 172254,
            },
            finish_solver_stats: FinishSolverStats {
                states: 3619,
                values: 37677,
