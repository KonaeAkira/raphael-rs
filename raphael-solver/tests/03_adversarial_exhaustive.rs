    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 4301140,
                pareto_values: 74818981,
            },
            step_lb_stats: StepLbSolverStats {
                states: 842949,
                pareto_values: 14857558,
            },
        }
    "#]];
...
fn test_rare_tacos_2() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 5027800,
                pareto_values: 135171653,
            },
            step_lb_stats: StepLbSolverStats {
                states: 1388845,
                pareto_values: 31625292,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn test_mountain_chromite_ingot_no_manipulation() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 3602310,
                pareto_values: 31757533,
            },
            step_lb_stats: StepLbSolverStats {
                states: 58468,
                pareto_values: 520164,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
...
fn test_rare_tacos_4628_4410() {
    ...
    let expected_runtime_stats = expect![[r#"
        MacroSolverStats {
            ...
            quality_ub_stats: QualityUbSolverStats {
                states: 5293573,
                pareto_values: 150777914,
            },
            step_lb_stats: StepLbSolverStats {
                states: 319254,
                pareto_values: 6969627,
            },
        }
    "#]];
    test_with_settings(solver_settings, expected_score, expected_runtime_stats);
